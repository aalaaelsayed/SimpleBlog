<?php
    ...
    $oldImage = $_POST["oldImage"];
		...
		try{
			$sql = "UPDATE `posts` SET `title`=?,`content`=?,`image`=?,`publish`=?,`id_cat`=? WHERE id = ?";
			$stmtcar = $conn->prepare($sql);
			$stmtcar->execute([$title,$description,$image_name,$publish,$cat_id,$id]);
	...
	include_once("includes/showcardata.php");
...
include_once("include/headcopy.php");
?>
			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="index.html" class="site_title"><i class="fa fa-car"></i> <span>Simple Blog System</span></a>
					</div>
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  method="POST" action="" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="content" required="required" class="form-control" > <?php echo $description;?></textarea>
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" name="publish" <?php echo $publishstr?>>
												</label>
											</div>
										</div>
										<div class="item form-group">
