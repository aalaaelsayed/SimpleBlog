...
try{
    $sql = "INSERT INTO `posts`(`title`,`content`,`image`,`publish`,`id_cat`) VALUES (?,?,?,?,?)";
    $stmt = $conn->prepare($sql);
    $stmt->execute([$title,$description,$image_name,$publish,$cat_id]); 
echo "data inserted successfully";
}catch(PDOException $e){
    echo "Connection failed: " . $e->getMessage();
}
	}else{
		echo"plz be sure to select the catgroy";
	}
}
//show categories
try{
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" id="image"  required="required" class="form-control" name="image"  accept="image/*">
