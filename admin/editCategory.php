<?php
	...
	include_once("includes/showcategorydata.php");
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data" >
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" required="required"  name ="category" class="form-control " value ="<?php  echo $cat_name;?>">
											</div>
										</div>
