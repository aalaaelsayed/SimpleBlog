...
if($_SERVER["REQUEST_METHOD"] ==="POST"){
    ...
    try{
        $sql = "INSERT INTO `users`( `email`, `fullname`, `password`, `name`,`active`) VALUES (?,?,?,?,?)";
        $stmt = $conn->prepare($sql);
        $stmt->execute([$email, $fullname ,$pass,$user,$active]); 
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" class="form-control " name="fullnam">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="email" class="form-control" type="email" name="emai" required="required">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" name="publish">
												</label>
											</div>
										</div>
										<div class="item form-group">
